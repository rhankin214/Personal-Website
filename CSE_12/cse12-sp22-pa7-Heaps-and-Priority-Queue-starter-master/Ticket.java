 ...
 * 
 * Ticket file for the autograder.
 */
 ...
 * node for a priority queue. Contains a static HashMap to determine
...
public class Ticket implements Comparable<Ticket>{
	...
	/**
	 * Compares two tickets first by their priority as listed on the map and
	 * then by their 
	 */
	@Override
	public int compareTo(Ticket other){
		if(orderMap.get(this.ticketType) != orderMap.get(other.ticketType))
		{
			...
			return orderMap.get(this.ticketType).
				compareTo(orderMap.get(other.ticketType));
		}
		else
